...
class AdminContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'ps_checkout.provider.funding_source' => 'getPsCheckout_Provider_FundingSourceService',
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3308', 'dbname' => 'gitcommit', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : ($this->services['annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader())) && false ?: '_'}, [0 => 'F:\\www\\wamp64\\www\\gitcommit\\modules\\ps_checkout\\src\\Entity']);
        $c->addExcludePaths([0 => 'F:\\www\\wamp64\\www\\gitcommit\\modules\\ps_checkout\\src\\Entity/index.php']);
        ...
        $a->setProxyDir('F:\\www\\wamp64\\www\\gitcommit/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_2f43f68c4ff6a77da83a058239f88cde01be70278b2c78634a428070fa0084c0');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'F:\\www\\wamp64\\www\\gitcommit/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'F:\\www\\wamp64\\www\\gitcommit/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.6.9', 'F:\\www\\wamp64\\www\\gitcommit');
    }
    ...
    {
        return $this->services['ps_checkout.paypal.configuration'] = new \PrestaShop\Module\PrestashopCheckout\PayPal\PayPalConfiguration(${($_ = isset($this->services['ps_checkout.configuration']) ? $this->services['ps_checkout.configuration'] : $this->getPsCheckout_ConfigurationService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the public 'ps_checkout.provider.funding_source' shared service.
     *
     * @return \PrestaShop\Module\PrestashopCheckout\FundingSourceProvider
     */
    protected function getPsCheckout_Provider_FundingSourceService()
    {
        return $this->services['ps_checkout.provider.funding_source'] = new \PrestaShop\Module\PrestashopCheckout\FundingSourceProvider(${($_ = isset($this->services['ps_checkout.module']) ? $this->services['ps_checkout.module'] : $this->getPsCheckout_ModuleService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'F:\\www\\wamp64\\www\\gitcommit/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'F:\\www\\wamp64\\www\\gitcommit/var/cache/prod/',
            ...
            'ps_cache_dir' => 'F:\\www\\wamp64\\www\\gitcommit/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'F:\\www\\wamp64\\www\\gitcommit/var/cache/prod//doctrine/orm/Proxies',
